...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        if ($user['role'] === 'siswa') {
            header("Location: dashboradsiswa1.php");
        } elseif ($user['role'] === 'staff') {
            header("Location: dahsboardStaf.php");
        } elseif ($user['role'] === 'siswab') { // Kondisi baru untuk role siswab
            header("Location: dashboardfajar.php");
        }
            ...
            <div class="modal-content">
                <form method="POST" action="register.php">
                    <div class="modal-header">
                        <h5 class="modal-title" id="registerModaltabel">Registrasi Akun</h5>
                    </div>
