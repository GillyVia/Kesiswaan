...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="dashboardsiswa1.css">
    </head>
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                <li>
                    <a href="dashboardfajar.php" class="active"><span class="las la-igloo"></span> 
                        <span>Dashboard</span></a>
                </li>
                <li>
                    <a href="absensiswab.php"><span class="las la-igloo"></span> 
                        <span>Absen</span></a>
                </li>
                <li>
                    <a href="pointfajar.php"><span class="las la-clipboard-list"></span> 
                        <span>Point</span></a>
                </li>
                <li>
    ...
    <div class="main-content">
        <header>
            <h3>
                ...
                <a href="logout.php"><button>Keluar <span class="las la-arrow-right"></a>
                </span></button>
        </header>
